...
\cvskill{ReactJS \& ReactNative} {+4 Mois} {0.4} \\[-7pt]
...
\cvskill{BasketBall \& Musculation} {Sport} {1} \\[-5pt]

\cvskill{Livre Scientifique \& Réportage} {Loisir} {1} \\[-5pt]
...
\cvtext{Je suis un jeune développeur informatique qui étudie actuellement à l'\' Ecole Supérieur des Technologies d'Information en licence 2. J'ai eu mon Bacc série D en 2020 à LPEF Sirama-Ambilobe.\\
...
\cvevent
	{Juin 2021 - Now}
	{Président et Fondateur de l'Association DevSuccess}
	{Une Association de jeune passioner de l'informatique}
	{Cette association regroupe une poigner de jeune passionner qui sont sois étudiant dans des universités ou  d'entreprise Concernant l'IT tel que :}
	{\cvlist{
...
{\cvlist{
		\item Les Téchnologies Web : 
			\cvlist{
				...
				\item \textbf{BackEnd :} JavaScript, NodeJS
				\item \textbf{DataBase :} MongoDb, MySQL		
			}
		\item Le Téchnologie Scientifique \textbf{Python} et ses Framework (Matplotbil et PyQT5).
		\item Les Technologie \textbf{Mobile} : Flutter, ReactNative, Java\\
		\item
	}}
